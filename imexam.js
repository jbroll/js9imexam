...
ndops._proj = typed(function (a, axis, proj) {
    var iX = 0, iY = 0;
...
ndops.median = function(a) {
	...
	Array.prototype.sort.call(data.data, function(a, b) { return a-b; });
        ...
        var reply = data.data[Math.round(data.size/2.0)];
...
ndops.gsfit1d = function(radi, data, x0) {
    //try {
	var opt = ndops.uncmin;

        return opt(function(x) {
    ...
    //}
    //catch(err) {
	//console.log("Error in optimization");
        //return x0;
    //}
};
